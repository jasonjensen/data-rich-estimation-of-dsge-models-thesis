...
fred_df_est, fred_mvts_est = load_and_treat_data(1986Q2:2019Q4, 1986Q2:2019Q4, fred_groups_sw);
...
@timeit to "MWG" m_final, res = metropolis_within_gibbs(m, data, Σ⁻¹; 
    ...
    progress_plots = true,
    speedup=true,
    # restore_from="data/results/partial_gelfer_2025-05-29T2247.jld2"
);

println("Done.")

store_results(res,m, "sw_dfm_2019Q4")